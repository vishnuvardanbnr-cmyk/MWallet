...
export const MVAULT_ABI = [
  ...
  "function adminUsdtPool() view returns (uint256)",
  ...
  "function poolCashOut(uint8 poolType, uint256 amount, address recipient) external",
  ...
  "function adminCreditBtcPool(address user, uint256 amount) external",
  "function adminDepositUsdtPool(uint256 amount) external",
...
export const BOARD_HANDLER_ABI = [
  ...
  "function getActiveQueueCount(uint256 _level) view returns (uint256)",
  ...
  "function adminSkipEntry(uint256 _level, uint256 _index) external",
